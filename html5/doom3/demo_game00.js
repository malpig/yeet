...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'demo_game00.data';
    var REMOTE_PACKAGE_BASE = 'demo_game00.data';
    ...
    function processPackageData(arrayBuffer) {
      ...
      var curr;
        ...
        DataRequest.prototype.byteArray = byteArray;
          ...
          console.info("demo_data00 loaded");
              Module['removeRunDependency']('datafile_demo_game00.data');

    };
    Module['addRunDependency']('datafile_demo_game00.data');
