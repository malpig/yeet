...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'demo_game01.data';
    var REMOTE_PACKAGE_BASE = 'demo_game01.data';
...
Module['FS_createPath']('/usr/local/share/d3wasm', 'base', true, true);
    ...
    function processPackageData(arrayBuffer) {
      ...
      console.info("demo_data01 loaded");
              Module['removeRunDependency']('datafile_demo_game01.data');

    };
    Module['addRunDependency']('datafile_demo_game01.data');
